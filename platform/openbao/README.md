...
* **Namespace**: `argos-observability` (ADR-052 — sin namespace `argos-secrets` dedicado, conjunto de 10 namespaces sin ampliar); acceso vía Kubernetes auth method ligado a las ServiceAccounts de `../../kubernetes/service-accounts/`.
